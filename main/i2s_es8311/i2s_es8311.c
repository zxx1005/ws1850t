...
static esp_err_t es8311_codec_init(void)
{
    ...
    static uint8_t voice_volume = 85;
    // es8311_handle_t es_handle = es8311_ng_create();
    es_handle = es8311_ng_create();
...
static void i2s_music(void *args)
{
    ...
    while (1)
    {
        ...
        else
        {
            ...
            cnt++;
            ESP_LOGI(TAG, "[music] i2s music cnt=%d.", cnt);
        }
...
void es8311_task(void)
{
    printf("i2s es8311 codec start\n-----------------------------\n");
